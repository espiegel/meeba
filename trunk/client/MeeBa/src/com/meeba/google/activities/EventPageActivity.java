...
public class EventPageActivity extends SherlockFragmentActivity implements EditEventDialog.EventUpdateCallback{
    ...
    private void shareEvent() {
        Toast.makeText(EventPageActivity.this, "Facebook sucks , so user needs to put text manually :(", Toast.LENGTH_SHORT);
        String shareBody = "Im going to: " + mEvent.getTitle() + "\nat " + mEvent.getWhere()
                + "\nGenerated By MeeBa ";

        Intent sharingIntent = new Intent(android.content.Intent.ACTION_SEND);
        sharingIntent.setType("text/plain");
        sharingIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, mEvent.getTitle());
