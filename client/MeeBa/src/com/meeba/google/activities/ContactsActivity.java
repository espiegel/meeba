...
public class ContactsActivity extends SherlockFragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPrefsEditor.clear();//TODO just for debugging , remove later.
    ...
    private void sendSms(List<User> dummies) {
        ...
        if(!dummies.isEmpty()) {
            ...
            for(User dummy : dummies) {
                ...
                //put phone 'phone-number->eid'  entry  in the waiting list .

                Utils.LOGD("maxtest=" + mEvent);
                mPrefsEditor.putInt(dummy.getPhone_number(),mEvent.getEid());
            }
            ...
            try {
                ...
                sendIntent.putExtra("sms_body", "Hey, you're invited to "+mTitle+" at "+mWhere+" at "+mWhen+"! Generated by MeeBa for Android: http://goo.gl/gWGoKx");
